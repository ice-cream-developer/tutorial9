...
import {VideoDetailViewsContainer, LoaderContainer} from './styledComponents'
...
class VideoDetailView extends Component {
  ...
  formattedData = data => ({
    ...
    viewsCount: data.video_details.views_count,
    ...
    return (
      <ThemeAndVideoContext.Consumer>
        {value => {
          ...
          const bgColor = isDarkTheme ? '#0f0f0f' : '#1f9ff9'

          return (
            <>
              <Header />
              <NavigationBar />
              <VideoDetailViewsContainer
